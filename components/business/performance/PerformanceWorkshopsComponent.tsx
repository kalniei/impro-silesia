...
const PerformanceWorkshopsComponent = ({ scrollTo }: PageProps): JSX.Element => {
  const goToContact = () => {
  ...
  return (
    <Grid item xs={12} py={6}>
      ...
      >
        ...
        >
          <img
            src={`/img/info/moze-warsztaty.jpg`}
            alt="warsztaty improwizacji"
            style={{ maxWidth: '100%' }}
          />
        </Grid>
      </Grid>
...
export default PerformanceWorkshopsComponent;
